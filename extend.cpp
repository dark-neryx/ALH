...
eEErr  CPythonEmbedder::InitGeneric()
{
    ...
    Py_SetProgramName((const wchar_t *)SZ_ALH_PROGRAM_NAME);
    Py_Initialize();
    m_bInitGeneric = TRUE;
...
{
	static struct PyModuleDef alh_unit_filter =
	{
	    PyModuleDef_HEAD_INIT,
		SZ_ALH_UNIT_FILTER_MODULE,
		"",
		-1,
		unitfltr_methods
	};
    ...
    PyModule_Create(&alh_unit_filter);
}
